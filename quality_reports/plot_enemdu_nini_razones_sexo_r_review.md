...
- **Legibilidad:** la imagen fue inspeccionada a resolución original; no presenta textos cortados, superpuestos ni elementos fuera del lienzo.
...
- **Salida:** genera `outputs/figures/37_ninis-dos-realidades-ecuador.png` a 300 dpi mediante `ragg::agg_png`.
...
Guardado: outputs/figures/37_ninis-dos-realidades-ecuador.png
```
