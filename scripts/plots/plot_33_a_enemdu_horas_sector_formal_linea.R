# ============================================================
# plot_33_a_enemdu_horas_sector_formal_linea.R
# Evolución de las horas promedio trabajadas por sexo en el
# sector formal, 2018-2026.
# Requiere: data/processed/enemdu_horas_sector_lineas_2018_2026.rds
# Guarda:   outputs/figures/33_a_horas-promedio_sector-formal-ecuador.png
# ============================================================
# Ejecutar desde la raiz del proyecto:
#   Rscript scripts/plots/plot_33_a_enemdu_horas_sector_formal_linea.R
# ============================================================
...
out_path <- "outputs/figures/33_a_horas-promedio_sector-formal-ecuador.png"
...
title_raw <- "La semana laboral de los trabajadores formales cada vez se acerca más al estándar de 40 horas"
subtitle_raw <- "Horas semanales promedio trabajadas, por sexo, ENEMDU mensual de diciembre 2018-2025, sector formal"
caption_raw <- paste(
