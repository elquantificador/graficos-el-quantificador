# ============================================================
# plot_47_enighur_gasolina_share_quintiles_years.R
...
# Guarda:   outputs/figures/47_gasolina-hogares-pobres-2012-2025.png
# ============================================================
...
out_path <- Sys.getenv(
  "OUT_PATH",
  unset = "outputs/figures/47_gasolina-hogares-pobres-2012-2025.png"
)
