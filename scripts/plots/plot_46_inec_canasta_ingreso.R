# ============================================================
# plot_46_inec_canasta_ingreso.R
...
#   Rscript scripts/plots/plot_46_inec_canasta_ingreso.R
# ============================================================
...
p_base <- ggplot2::ggplot() +
  ...
  ggplot2::annotate(
    ...
    x = canasta_value - 180,
    y = label_y,
    label = paste0("Canasta\nbásica\n$", format(round(canasta_value), big.mark = ".", decimal.mark = ",", scientific = FALSE)),
    hjust = 1,
    vjust = 0.5,
    size = 3,
    lineheight = 0.95,
  ...
  ggplot2::annotate(
    ...
    y = label_y,
    label = paste0("Ingreso familiar de referencia\n(1,6 salarios básicos\nunificados)\n$", format(round(ingreso_familiar), big.mark = ".", decimal.mark = ",", scientific = FALSE)),
    hjust = 0,
    vjust = 0.5,
    size = 3,
    lineheight = 0.95,
