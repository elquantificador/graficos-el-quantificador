# ============================================================
# plot_17_reess_salario_industrias.R
...
# Guarda:   outputs/figures/17_salario-industrias_formal-ecuador.png
# ============================================================
# Ejecutar desde la raíz del proyecto:
#   Rscript scripts/plots/plot_17_reess_salario_industrias.R
# ============================================================
...
out_path <- "outputs/figures/17_salario-industrias_formal-ecuador.png"
...
title_raw <- paste0(
  "Los sectores mejor pagados del Ecuador apenas concentran ",
  format(round(share_top5, 0), decimal.mark = ","), "% del empleo formal"
)
caption_raw <- paste0(
  "Fuente: Registro Estadístico de Empleo en la Seguridad Social (REESS), corte de febrero 2026. ",
  "Cálculos por Santiago Guamán para El Quantificador de Laboratorio LIDE. Salario mensual promedio del empleo ",
